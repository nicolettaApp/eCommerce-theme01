        ...
        <div class="wrapper">
          ...
          <?php
            ...
            if(isset($cnx)) {
              ...
              echo '<img src="images/'.$prod->fisier_imagine.'" alt="" />';
          echo "</div>";

              echo "<h6>Informatii</h6><p>$prod->descriere</p>";

              echo "<h6>Despre produs</h6><p>$prod->read_more</p>";
              echo '<h6>Pret</h6><p class="bold">'.$prod->pret.' lei</p>';

              echo '<div class="pret"><a href="./cumpar.php" class="btn btn-info" role="button">MOMENTAN MAGAZINUL NU ESTE ACTIVAT </a>	
</div>';
