        ...
        <div class="wrapper">
          ...
          if(isset($cnx)) {
            ...
            while ($prod = $stmt->fetchObject('Produse')) {
              ...
              echo "<h3><span class=\"dropcap\">".$id."</span>".$nume."</h3>";
              echo '<figure><a href="element.php?idprod='.$id.'"><img src="images/'.$img.'" alt="" /></a></figure>';
              echo '<p class="pad_bot1"<'.$descriere.'</p>';
              echo '<a href="element.php?idprod='.$id.'" class=\"link1\">Mai multe...</a>';
              echo "</div>";
              echo "</div></section>";
            }
            $cnx = null;
